            ...
            <div class="nav-collapse collapse">
              <ul class="nav">
                ...
                <li class="pull-right"><a href="<?php echo e(route('monpanier')); ?>">
                  ...
                  <span class="badge badge-pill badge-dark"> <?php echo e(Cart::count()); ?> </span></a>
                </li>
              </ul>
        ...
        <div class="item">
          ...
          <div class="container">
            <div class="carousel-caption">
              ...
              <a class="btn btn-large btn-primary" href="<?php echo e(route('articles')); ?>">Voir les articles</a>
            </div>
          </div>
        </div>
        <div class="item">
          ...
          <div class="container">
            <div class="carousel-caption">
              ...
              <a class="btn btn-large btn-primary" href="<?php echo e(route('inscription')); ?>">Rejoignez nous</a>
            </div>
          </div>
        </div>
      </div>
